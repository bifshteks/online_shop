...
// 						wc_cart_fragments_params.fragment_name,JSON.stringify(d.fragments)),
// 					c(d.cart_hash),d.cart_hash&&b()),
// 					a(document.body).trigger("wc_fragments_refreshed"))
// 			}
// 		};
// 		if(e){
// 			var h=null,i=864e5;a(document.body).on("wc_fragment_refresh updated_wc_div",function(){
// 				d()
// 			}),
// 			a(document.body).on("added_to_cart",function(a,d,e){
// 				var g=sessionStorage.getItem(f);
// 				null!==g&&void 0!==g&&""!==g||b(),
// 				sessionStorage.setItem(wc_cart_fragments_params.fragment_name,JSON.stringify(d)),
// 				c(e)
// 			}),
...
// 				if(null!==k&&void 0!==k&&""!==k||(k=""),
// 					null!==l&&void 0!==l&&""!==l||(l=""),k&&(null===m||void 0===m||""===m))
// 					throw"No cart_created";
// 				if(m){var n=1*m+i,o=(new Date).getTime();
// 					if(n<o)throw"Fragment expired";
// 					h=setTimeout(d,n-o)}if(!j||!j["div.widget_shopping_cart_content"]||k!==l)throw"No fragment";
// 					a.each(j,function(b,c){a(b).replaceWith(c)}),a(document.body).trigger("wc_fragments_loaded")
// 			}
// 			catch(a){
// 				d()
// 			}
// 		} else d();
// 			Cookies.get("woocommerce_items_in_cart")>0?a(".hide_cart_widget_if_empty").closest(".widget_shopping_cart").show():a(".hide_cart_widget_if_empty").closest(".widget_shopping_cart").hide(),
